...
for trial_duration in trials:
    ...
    trial_feedback.setText(f'${reward}.00')
    exp_feedback.setText(f'[${total_earnings}.00]')
    ...
    # the response time above, and we maybe log a warning
    # if it's too different from fix.after.feedback)
    trial_time = trialClock.getTime()
    # TODO
    actual_fix_after_feedback = trial_details['fix.after.feedback']
    show_fixation(actual_fix_after_feedback)
